...
@echo off
Set "version= V.1.4"
title Batlez Tweaks - Boost FPS and Reduce Latency
cls
color d
cls
...
echo.
echo.
echo                          You are currently on the %version% !
echo.
echo                        - Thank you for using Batlez Tweaks! -
echo _______________________________________________________________________________
echo.
echo                         Press any key to start Batlez Tweaks!                            
pause >nul
:continue
cls
color d
...
echo -                         Choices                             -     Type:     -
echo -                                                             -               -
echo - Reset Current Settings                                      -      [1]      -
echo - Apply Custom Regedit                                        -      [2]      -
echo - GPU Optimizations (AMD)                                     -      [3]      -
echo - Network Tweaks                                              -      [4]      -
echo - CPU Booster                                                 -      [5]      -
echo - Process Prioritizer                                         -      [6]      -
echo - Mouse/Keyboard Tweaks                                       -      [7]      -
echo - Internet Refresher                                          -      [8]      -
echo - Custom Graphics Card Drivers                                -      [9]     -
echo _______________________________________________________________________________
echo.
echo                   ============Press "L" to Leave============                      
set /p Choice=Choose Your Tweak=

if /i '%Choice%'=='1' goto Reset
if /i '%Choice%'=='2' goto Regedit
if /i '%Choice%'=='3' goto FPS
if /i '%Choice%'=='4' goto Network
if /i '%Choice%'=='5' goto CPU
if /i '%Choice%'=='6' goto Process
if /i '%Choice%'=='7' goto MouseAndKeyboard
if /i '%Choice%'=='8' goto internetrefresher
if /i '%Choice%'=='9' goto DriverMAN
if /i '%Choice%'=='L' goto Leave
cls
...
echo Menu [1-8] or select 'L' to Leave.
echo _____________________________________
echo.
...
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Services\Tcpip\Parameters\Interfaces\{2B3A2CDF-9098-4109-B4B7-8E3C905D609D}" /v "UseZeroBroadcast" /t REG_DWORD /d "255" /f
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Services\Tcpip\Parameters\Interfaces\{2B3A2CDF-9098-4109-B4B7-8E3C905D609D}" /v "TCPNoDelay" /t REG_DWORD /d "1" /f
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Services\Tcpip\Parameters\Interfaces\{2B3A2CDF-9098-4109-B4B7-8E3C905D609D}" /v "TcpAckFrequency" /t REG_DWORD /d "1" /f
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Services\Tcpip\Parameters\Interfaces\{2B3A2CDF-9098-4109-B4B7-8E3C905D609D}" /v "TcpDelAckTicks" /t REG_DWORD /d "0" /f
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Services\Tcpip\Parameters\Interfaces\{2B3A2CDF-9098-4109-B4B7-8E3C905D609D}" /v "TcpWindowSize" /t REG_DWORD /d "5312512" /f
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Services\Tcpip\Parameters\Interfaces\{2B3A2CDF-9098-4109-B4B7-8E3C905D609D}" /v "TcpInitialRTT" /t REG_DWORD /d "32767" /f
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Services\Tcpip\Parameters\Interfaces\{2B3A2CDF-9098-4109-B4B7-8E3C905D609D}" /v "NameServer" /t REG_SZ /d "8.8.8.8,8.8.4.4" /f
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Services\Tcpip\Parameters\Interfaces\{2B3A2CDF-9098-4109-B4B7-8E3C905D609D}" /v "MTU" /t REG_DWORD /d "1500" /f
...
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Services\Tcpip\Parameters" /v "SizReqBuf" /t REG_DWORD /d "95268" /f
...
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Services\Tcpip\Parameters" /v "TcpMaxHalfOpen" /t REG_DWORD /d "100" /f
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Services\Tcpip\Parameters" /v "TcpMaxPortsExhausted" /t REG_DWORD /d "5" /f
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Services\Tcpip\Parameters" /v "TcpMaxHalfOpenRetried" /t REG_DWORD /d "100" /f
...
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Services\Tcpip\Parameters" /v "TcpWindowSize" /t REG_DWORD /d "5312512" /f
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Services\Tcpip\Parameters" /v "EnableConnectionRateLimiting" /t REG_DWORD /d "0" /f
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Services\Tcpip\Parameters" /v "NetDMA" /t REG_DWORD /d "0" /f
...
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Services\AFD\Parameters" /v "DefaultReceiveWindow" /t REG_DWORD /d "71044" /f
Reg.exe add "HKLM\SYSTEM\CurrentControlSet\Services\AFD\Parameters" /v "DefaultSendWindow" /t REG_DWORD /d "10262" /f
...
color b
cls
echo what are you using right now?
set /p gpu=amd/nvidia
IF /I "%gpu%"=="amd" goto amd


IF /I "%gpu%"=="nvidia" goto nvidia
cls
...
mkdir c:\users\administrator\desktop\amd
powershell Invoke-WebRequest -Uri "https://github.com/Matishzz/Clean-AMD-Drivers/releases/download/AMD/20.8.1.W76A_INF.w7.w8.zip" -OutFile "c:\users\administrator\desktop\amd\driver.zip"
powershell Invoke-WebRequest -Uri "https://raw.githubusercontent.com/imribiy/amd-gpu-tweaks/main/AMD%20DWORDs.bat" -OutFile "C:\users\administrator\desktop\amd\AMDDWORD"
echo do not run the reg before installing the driver >>"c:\users\administrator\desktop\amd\readme.txt"
cls 
:nvidia
start /wait NVCleanstall.exe
mkdir c:\users\administrator\desktop\nvidia
powershell Invoke-WebRequest -Uri "https://cdn.discordapp.com/attachments/925776230643560488/926146547220094987/NVIDIA_v2.reg" -OutFile "c:\users\administrator\desktop\nvidia\Nvidia.reg"
powershell Invoke-WebRequest -Uri "https://cdn.discordapp.com/attachments/925776230643560488/926290161581584425/NvContainer.bat" -OutFile "c:\users\administrator\desktop\nvidia\NvContainer.bat"
powershell Invoke-WebRequest -Uri "https://cdn.discordapp.com/attachments/925776230643560488/926290161766105168/NvTelemetry.bat" -OutFile "c:\users\administrator\desktop\nvidia\Nvtelemetry.bat"
echo do not run the tweaks before installing the driver >>"c:\users\administrator\desktop\nvidia\readme.txt"
cls
color d
cls
...
echo _______________________________________________________________________________
echo.
echo -    Thank you for using Batlez Tweaks! Press any key to exit the program.    -
echo -    Make sure to restart your PC, otherwise the settings will NOT work!      -
echo _______________________________________________________________________________
echo. 
echo                        Press any key to close Batlez Tweaks!                       
pause >nul
cls
exit

...
echo.
echo                    - Thank you for making use of Batlez Tweaks! -
echo _______________________________________________________________________________
echo.
...
echo - CPU Booster                                                 -      [5]      -
echo - Ping Refresher                                              -      [6]      -
echo - Process Prioritizer                                         -      [7]      -
echo - Mouse/Keyboard Tweaks                                       -      [8]      -
echo - Internet Refresher                                          -      [9]      -
echo - Custom Graphics Card Drivers                                -      [10]     -
echo _______________________________________________________________________________
echo.
...
if /i '%Choice%'=='6' goto Ping
if /i '%Choice%'=='7' goto Process
if /i '%Choice%'=='8' goto MouseAndKeyboard
if /i '%Choice%'=='9' goto internetrefresher
if /i '%Choice%'=='10' goto DriverMAN
